...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        'data-[state=unchecked]:tranzinc-x-0 data-[state=checked]:tranzinc-x-5 pointer-events-none block h-5 w-5 rounded-full bg-white shadow-lg ring-0 transition-transform',
      )}
    />
  </SwitchPrimitives.Root>
));
